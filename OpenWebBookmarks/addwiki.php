...
//fwrite($myfile, $dd);
//fwrite($myfile, "-");
fwrite($myfile, '<a href="https://en.wikipedia.org/w/index.php?action=render&title=' );
fwrite($myfile, $input);
fwrite($myfile, '">Link</a>');
fwrite($myfile, ' ; ');
fwrite($myfile, $input);
fwrite($myfile, '<br>');
fwrite($myfile, "\n");
...
// https://en.wikipedia.org/w/index.php?action=render&title=Vietnam
?>
